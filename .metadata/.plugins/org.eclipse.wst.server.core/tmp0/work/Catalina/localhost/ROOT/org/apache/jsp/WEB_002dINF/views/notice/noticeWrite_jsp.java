 ...
 * Generated at: 2019-10-10 01:09:31 UTC
...
public final class noticeWrite_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/header.jsp", Long.valueOf(1570668008585L));
  }
...
if(m==null){ 
      ...
      out.write("\t\t\t<!-- 파일 업로드 양식이란걸 알려주기 위해  method=\"post\" enctype=\"multipart/form-data\" 는 반드시 해야함-->\r\n");
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th colspan=\"2\" style=\"font-size:20px; font-weight:bold\">공지사항 작성</th>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th>제목</th>\r\n");
      ...
      out.write("\t\t\t\t\t\t<th>내용</th>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- 여러줄 입력(엔터입력)을 위한 textarea -->\r\n");
      out.write("\t\t\t\t\t\t\t<textarea rows=\"3\" cols=\"40\" name=\"noticeContent\" class=\"form-control\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
